...
class _MyHomePageState extends State<pan> {
  ...
  List<Image> panoImages = [
    Image.asset('assets/image/Edit.jpeg'),
    Image.asset('assets/image/onemore.jpeg'),
    Image.asset('assets/image/Edit.jpeg'),
  ];
    ...
    switch (_panoId % panoImages.length) {
      case 0:
        panorama = Panorama(
          ...
          child: Image.asset('assets/image/Edit.jpeg'),
          hotspots: [
            Hotspot(
              latitude: -15.0,
              longitude: -129.0,
